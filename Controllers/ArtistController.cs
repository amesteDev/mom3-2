...
namespace records.Controllers
{
    public class ArtistController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Country")] Artist artist)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Name,Country")] Artist artist)
        {
            if (id != artist.Name)
            {
                return NotFound();
        ...
        {
            return _context.Artist.Any(e => e.Name == id);
        }
    }
}
